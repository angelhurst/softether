...
class ListDevice(APIView):
    ...
    def get(self, request, format=None):
        ...
        table_ip = parsing('/usr/local/vpnserver/vpncmd /SERVER localhost:5555  /HUB:VPN /CMD iptable')
        table_dhcp = parsing('/usr/local/vpnserver/vpncmd /SERVER localhost:5555 /HUB:VPN /CMD dhcptable')
